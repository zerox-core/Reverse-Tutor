...
> **唯一主线开发宪章：** 所有产品任务必须先阅读并遵循 [`docs/PROJECT_DEVELOPMENT_MAINLINE.md`](docs/PROJECT_DEVELOPMENT_MAINLINE.md)。该文档规定 `newmp` 的拓扑式开发顺序、最小垂直切片和 TDD 门禁；如与具体任务计划冲突，先停机确认。
